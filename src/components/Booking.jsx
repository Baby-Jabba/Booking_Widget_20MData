  ...
  handleCalendarRowItemClick(dayIndex, e) {
    if (this.state.areCheckInCalendarsActive) {
      if (dayIndex >= this.state.sessionCheckOut) {
        let newSessionCheckOut =
          dayIndex + this.state.sessionCheckOut - this.state.sessionCheckIn;
        this.setState({
    ...
    return (
      <div style={{ display: 'inline-block', backgroundColor: '#f2f2f2' }}>
        ...
        >
          <div
            id='viewers'
            style={{ height: '15px', margin: '8px 0', padding: '15px' }}
          >
            <div
              id='viewerMessage'
              style={{
          ...
          <div id='userInputs'>
                  ...
                  <div style={{ marginLeft: 30 }}>
                    <div
                      style={{
                        textAlign: 'left',
                        fontFamily:
                          'Arial,Tahoma,Bitstream Vera Sans,sans-serif',
                        fontSize: 13,
                        color: '#4A4A4A',
                        marginBottom: 5,
                        marginTop: 5,
              ...
              >
                ...
                >
                  ...
                  <div style={{ marginLeft: 30 }}>
                    ...
                    >
                      {
                        this.state.days[this.state.sessionCheckOut]
                          .CheckInOutFormatted
                      }
                    </div>
                  </div>
            ...
            >
              ...
              <div style={{ marginLeft: 30 }}>
                ...
                >
                  {this.state.sessionRooms} room, {this.state.sessionAdults}{' '}
                  adults, {this.state.sessionChildren} children
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div id='months'>
              ...
              >
                ...
                >
                  <div style={{ display: 'inline-block' }}>
                    {this.state.months[this.state.leftMonthIndex].month}
                  </div>
                  <div
                ...
                <Calendar
                  rows={this.state.months[this.state.leftMonthIndex]}
                  days={this.state.days}
                  handleCalendarRowItemClick={this.handleCalendarRowItemClick.bind(
                    this
                  )}
                />
              </div>
              ...
              >
                ...
                >
                  <div style={{ display: 'inline-block' }}>
                    {this.state.months[this.state.rightMonthIndex].month}
                  </div>
                  <div
                ...
                <Calendar
                  rows={this.state.months[this.state.rightMonthIndex]}
                  days={this.state.days}
                  handleCalendarRowItemClick={this.handleCalendarRowItemClick.bind(
                    this
                  )}
        ...
        {this.state.isGuestInformationActive ? (
          <div
            id='guestInfo'
            style={{
              position: 'absolute',
          ...
          >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    border: '1px solid #e5e5e5',
                    fontWeight: 400,
                    boxShadow: 'inset 0 3px 3px -3px rgba(0,0,0,.25)'
                  }}
                >
                  {this.state.sessionRooms}
                </div>
                <div
                  style={{
                    display: 'flex',
            ...
            >
              ...
              >
                <div
                  ...
                  onClick={e => {
                    this.handleToggleDownGuestInfoCategory(
                      'sessionChildren',
                      e
                    );
                  }}
            ...
            <div style={{ paddingTop: 16 }}>
              <button
                ...
                onClick={e => {
                  this.handleGuestInfoUpdateClick(e);
                }}
              >
                Update
              </button>
